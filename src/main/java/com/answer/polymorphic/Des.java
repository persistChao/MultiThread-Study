...
public class Des {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(Des.encrypt(data, Charset.forName("utf8"), "testtest"));

        System.out.println(Des.decrypt(data, Charset.forName("utf8"), "testtest"));
    }
}
